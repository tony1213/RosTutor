package com.robot.et.android_ros_common.view;
...
import com.robot.et.android_ros_common.R;
 ...
 */
public class VirtualJoystickView extends RelativeLayout implements Animation.AnimationListener,
    ...
    public void onStart(ConnectedNode connectedNode) {
        ...
        publisherTimer.schedule(new TimerTask() {
            ...
            public void run() {
                if (publishVelocity) {
                    Log.e("VirtualJoystick", "topicName:"+topicName);
                    publisher.publish(currentVelocityCommand);
                }
            }
        }, 0, 80);
